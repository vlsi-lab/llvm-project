...
Value *CodeGenFunction::EmitRISCVBuiltinExpr(unsigned BuiltinID,
  ...
  case RISCV::BI__builtin_riscv_acos_q:
    ...
    break;
  case RISCV::BI__builtin_riscv_cosh_q:
    ID = Intrinsic::riscv_cosh_q;
    break;
  case RISCV::BI__builtin_riscv_sinh_q:
    ID = Intrinsic::riscv_sinh_q;
    break;
  ...
  case RISCV::BI__builtin_riscv_hypotenuse_q:
    ...
    break;
  case RISCV::BI__builtin_riscv_div_q:
    ID = Intrinsic::riscv_div_q;
    break;
